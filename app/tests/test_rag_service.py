...
@pytest.fixture
def rag_service(mock_embedding_service, in_memory_vector_store) -> RAGService:
    """Fixture initializing RAGService with mocked embedding service and in-memory vector store."""
    return RAGService(
...
def test_search_relevant_chunks(
    ...
    """Verify search converts text query into vector and returns mapped results."""
...
def test_search_no_results_found(rag_service: RAGService):
